...
contract OPHXNFT is Context, ERC165, IERC721, IERC721Metadata, ReentrancyGuard, Ownable {
    using Address for address;
    using SafeMath for uint256;

    // Token name
    string private constant _name = "Operation Phoenix NFT";

    // Token symbol
    string private constant _symbol = "OPHXNFT";
    ...
    // Mapping from owner to claimed rewards
    ...
    // Mint Recipient
    address public mintRecipient = 0x1178A0F8895611daBC07729C6d1D29D1fC204c19;
    ...
    function donateToBalance() external payable {}
    ...
    function _claimRewards(address user) internal {
        ...
        // add to total rewards claimed
        unchecked {
            totalClaimed[user] += pending;
        }
