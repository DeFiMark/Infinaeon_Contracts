...
contract CrossChainReceiverBSC is Ownable, AxelarExecutable {
     ...
     */
    address public aUSDC = 0x4268B8F0B87b6Eae5d897996E6b845ddbD99Adf3;

    /**
        V2 Router Contract
     */
    IUniswapV2Router02 public V2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);

    /**
        V3 Router Contract
     */
    ISwapRouter public swapRouter = ISwapRouter(0x13f4EA83D0bd40E75C8222255bc855a974568Dd4);
    ...
    // set v3 router
    function setV3Router(address _V3Router) external onlyOwner {
        require(_V3Router != address(0), 'Zero Address');
        swapRouter = ISwapRouter(_V3Router);
    }
    ...
    // set v3 fee
    function setV3Fee(uint24 v3Fee_) external onlyOwner {
        v3Fee = v3Fee_;
    }
    ...
    function _swap(uint256 amount) internal returns (uint256) {
        ...
        // approve of v3 pool
        uint256 bal = IERC20(path[path.length - 1]).balanceOf(address(this));

        // approve of middle token to v3 dex
        TransferHelper.safeApprove(path[path.length - 1], address(swapRouter), bal);
        ...
        ISwapRouter.ExactInputSingleParams({
            ...
            tokenOut: aUSDC,
            fee: v3Fee, // have setter for this
    ...
    function _swapToETH(address to, uint256 minOut) internal {
        ...
        // approve of v3 pool
        uint256 bal = IERC20(aUSDC).balanceOf(address(this));

        // approve of middle token to v3 dex
        TransferHelper.safeApprove(aUSDC, address(swapRouter), bal);
        ...
        // approve
        TransferHelper.safeApprove(path[1], address(V2Router), IERC20(path[1]).balanceOf(address(this)));

        // swapping USDT to ETH
